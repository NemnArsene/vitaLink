...
export default function PatientDetail() {
  ...
  const myConsultations = consultations.filter(c => c.patientId === id).slice(0, 5);
  const myInvoices = invoices.filter(i => i.patientId === id).slice(0, 5);
          ...
          <CardContent className="space-y-5">
            ...
            <div>
              ...
              <div className="space-y-2">
                {record?.allergies.length === 0 && <p className="text-xs italic" style={{ color: "var(--text-muted)" }}>Aucune allergie connue</p>}
            ...
            <div>
              ...
              <div className="space-y-2">
                {record?.conditions.length === 0 && <p className="text-xs italic" style={{ color: "var(--text-muted)" }}>Aucun antécédent déclaré</p>}
